...
public class ExplosionTask extends ParticleTask {
	//Generation Variables
	protected double spiralSpeed;

	public ExplosionTask() {
		super();
	...
	protected boolean update() {
		spawn((int)(30*Controller.particleQuality), new XY(4, 4), Color.RED, 6/Controller.particleQuality, 0.1/Controller.particleQuality);
		spawn((int)(10*Controller.particleQuality), new XY(4, 4), Color.YELLOW, 6/Controller.particleQuality, 0.1/Controller.particleQuality);
